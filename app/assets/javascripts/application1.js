...
//**this is the sliding image function**//
galleryid: "galleryid";
...
var stepcarousel={
	...
	addnavbuttons:function($, config, currentpanel){
		config.$leftnavbutton=$('<img src="/assets/bampict/arrow_left.png"'+config.defaultbuttons.leftnav[0]+'" class="' + config.galleryid + '_navbutton">').css({zIndex:50, position:'absolute', left:config.offsets.left+config.defaultbuttons.leftnav[1]+'px', top:config.offsets.top+config.defaultbuttons.leftnav[2]+'px', cursor:'hand', cursor:'pointer'}).attr({title:'Back '+config.defaultbuttons.moveby+' panels'}).appendTo('body')
		config.$rightnavbutton=$('<img src="/assets/bampict/arrow_right.png"'+config.defaultbuttons.rightnav[0]+'" class="'  + config.galleryid + '_navbutton">').css({zIndex:50, position:'absolute', left:config.offsets.left+config.$gallery.get(0).offsetWidth+config.defaultbuttons.rightnav[1]+'px', top:config.offsets.top+config.defaultbuttons.rightnav[2]+'px', cursor:'hand', cursor:'pointer'}).attr({title:'Forward '+config.defaultbuttons.moveby+' panels'}).appendTo('body')
...
stepcarousel.setup({
	...
	defaultbuttons: {enable: true, moveby: 1, leftnav: ['arrowl.gif', -30, 300], rightnav: ['arrowr.gif', -10, 300]},
...
function submitFunction() {
	var first = document.forms["ContactUs"]["firstname"].value;
	var second = document.forms["ContactUs"]["lastname"].value;
